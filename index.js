...
function rallyUptheTeam() {
  ...
  function startUp() {
    ...
    const longText = 'This app is intended to help you keep your employees organized! ';
                ...
                db.searchAllEmpInfo()
                  .then(([rows]) => {
                    ...
                    inquirer.prompt({
                      type: "list",
                      name: "managerId",
                      message: "Select a manager to be assigned to this employee.",
                      choices: managerChoices
                    })
                      .then(res => {
                        let employee = {
                      ...
                      .then(() => console.log(`You have succesfully added ${firstName} ${lastName} to the employee database!`))
                      .then(() => letsGetOrganized())
                  })
              })
          })
        ...
        inquirer.prompt([
          {
            type: "list",
            name: "employeeId",
            message: "Select the employee you would like to remove from the database.",
            ...
            db.searchRolesInfo()
              .then(([rows]) => {
                ...
                inquirer.prompt([
                  ...
                  .then(() => console.log("You have succesfully updated the employee's role."))
                  .then(() => letsGetOrganized())
              });
          });
      })
            ...
            db.findAllPossibleManagers(employeeId)
              .then(([rows]) => {
                ...
                inquirer.prompt([
                  ...
                  .then(() => console.log("You have succesfully updated employee's manager"))
                  .then(() => letsGetOrganized())
              })
          })
      })
    ...
    db.searchDepInfo()
      .then(([rows]) => {
        ...
        inquirer.prompt([
          ...
          .then(role => {
            db.createRole(role)
              .then(() => console.log(`You have succesfully added ${role.title} to the employee database.`))
              .then(() => letsGetOrganized())
          })
      })
  }
        ...
        inquirer.prompt([
          {
            type: "list",
            name: "roleId",
            message: "You have selected to deleted a role from the employee database. Keep in mind that when you delete a role the fiel!",
            choices: roleChoices
          }
        ])
          .then(res => db.removeRole(res.roleId))
          .then(() => console.log("You have succesfully deleted this role from the employee database."))
          .then(() => letsGetOrganized())
      })
  }
    ...
    db.searchDepInfo()
      .then(([rows]) => {
        ...
        inquirer.prompt(
          ...
          .then(() => console.log(`You have removed department from the employee database.`))
          .then(() => letsGetOrganized())
      })
  }
